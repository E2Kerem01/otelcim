  ...
  group('SeasonalCalendarScreen Widget Tests', () {
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        // In proper implementation fixing D23, 2026 season options like 'Yaz 2026' or 'yaz_2026' must exist
        expect(find.textContaining('2026'), findsWidgets,
            reason: 'Seasonal reminder options must include 2026 seasons (D23)');
      },
      // BUG-u5-03: Seasonal calendar does not support 2026 seasons in target season options (D23)
      skip: true,
    );
  });
}
