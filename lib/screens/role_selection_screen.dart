...
class _RoleSelectionScreenState extends ConsumerState<RoleSelectionScreen> {
  ...
  /// Confirm role selection and update Firestore
  Future<void> _confirmRoleSelection() async {
    ...
    try {
      ...
      // Navigate to next screen (profile setup)
      // TODO: Replace with actual navigation in future subtasks
      if (mounted) {
        Navigator.of(context).pushReplacementNamed('/profile-setup');
      }
    } catch (e) {
      setState(() {
        _errorMessage = 'Rol güncellenirken bir hata oluştu: $e';
        _isLoading = false;
      });
    }
  }
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(
                ...
                child: FilledButton(
                  onPressed: _isLoading ? null : _confirmRoleSelection,
