...
class _NotificationSettingsScreenState
  ...
  Future<void> _updatePreference(
      String key, bool value, UserProfile profile) async {
    final currentPrefs =
        Map<String, bool>.from(profile.notificationPreferences);
  ...
  Future<void> _selectQuietHour(
      BuildContext context, bool isStart, UserProfile profile) async {
    final currentString =
        isStart ? profile.quietHoursStart : profile.quietHoursEnd;
    ...
    return Scaffold(
      ...
      body: profileAsync.when(
        ...
        data: (profile) {
          ...
          final hasQuietHours = profile.quietHoursStart != null ||
              ...
              children: [
                ...
                Card(
                  ...
                  child: Column(
                    children: [
                      SwitchListTile(
                        secondary: Icon(Icons.chat_bubble_outline_rounded,
                            color: Theme.of(context).primaryColor),
                        title: const Text('Mesajlar',
                            style: TextStyle(
                                fontWeight: FontWeight.bold, fontSize: 15)),
                        subtitle:
                            const Text('Yeni sohbet mesajları için bildirim al'),
                      ...
                      const Divider(height: 1),
                      SwitchListTile(
                        secondary: Icon(Icons.calendar_month_outlined,
                            color: Theme.of(context).primaryColor),
                        title: const Text('Sezonluk Hatırlatıcılar',
                            style: TextStyle(
                                fontWeight: FontWeight.bold, fontSize: 15)),
                        subtitle: const Text(
                        ...
                        onChanged: (val) =>
                            _updatePreference('seasonalReminders', val, profile),
                      ),
                      const Divider(height: 1),
                      SwitchListTile(
                    ...
                    children: [
                      ...
                      if (hasQuietHours) ...[
                        ...
                        ListTile(
                          ...
                          title: const Text('Sessiz Saatleri Temizle',
