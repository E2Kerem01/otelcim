    ...
    return Center(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Icon(Icons.favorite_border_rounded, size: 64, color: colorScheme.outlineVariant),
        ...
        child: Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              if (listing.images.isNotEmpty) ...[
                ClipRRect(
                  ...
                  child: CachedNetworkImage(
                    ...
                    height: 60,
                    fit: BoxFit.cover,
                    placeholder: (_, _) => Container(color: colorScheme.surfaceContainerHighest, width: 60, height: 60),
                    errorWidget: (_, _, _) => Icon(Icons.broken_image, size: 24, color: colorScheme.onSurfaceVariant),
                  ),
                ),
              ...
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                if (listing.location.isNotEmpty) ...[
                  ...
                  Row(children: [
                    ...
                    Expanded(child: Text(listing.location, maxLines: 1, overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 12, color: colorScheme.onSurfaceVariant))),
                  ]),
                ],
              ])),
            ]),
            if (listing.salary.isNotEmpty) ...[
              const SizedBox(height: 6),
              Text(listing.salary, style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: colorScheme.primary)),
            ],
          ]),
        ),
      ),
